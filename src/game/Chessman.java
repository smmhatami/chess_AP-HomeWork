...
public class Chessman {
    ...
    private boolean moveValidatePawn(BoardUnitSquare startSquare, BoardUnitSquare destinationSquare, Player owner) {
        ...
        if (destinationSquare.getSquareFrontRow(playerMovingSide).getSquareRightRow(1) == destinationSquare)
            return true;
        return destinationSquare.getSquareFrontRow(playerMovingSide).getSquareRightRow(-1) == destinationSquare;
    }
